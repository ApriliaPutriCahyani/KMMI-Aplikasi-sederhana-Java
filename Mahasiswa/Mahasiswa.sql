...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.0.4&nocache=6285754692ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="tbl_recent_favorite.php?db=mahasiswa&amp;table=mahasiswa">`mahasiswa`.`mahasiswa`</a></li><li class="warp_link"><a href="tbl_recent_favorite.php?db=mahasiswa&amp;table=Mahasiswa">`mahasiswa`.`Mahasiswa`</a></li><li class="warp_link"><a href="tbl_recent_favorite.php?db=tugaskaryawan&amp;table=karyawan">`tugaskaryawan`.`karyawan`</a></li><li class="warp_link"><a href="tbl_recent_favorite.php?db=kmmi2&amp;table=barang">`kmmi2`.`barang`</a></li><li class="warp_link"><a href="tbl_recent_favorite.php?db=kmmik2&amp;table=barang">`kmmik2`.`barang`</a></li><li class="warp_link"><a href="tbl_recent_favorite.php?db=kmmik2&amp;table=Barang">`kmmik2`.`Barang`</a></li><li class="warp_link"><a href="tbl_recent_favorite.php?db=tugaskaryawan&amp;table=Karyawan">`tugaskaryawan`.`Karyawan`</a></li><li class="warp_link"><a href="tbl_recent_favorite.php?db=kmmi2&amp;table=Barang">`kmmi2`.`Barang`</a></li><li class="warp_link"><a href="tbl_recent_favorite.php?db=barang&amp;table=sd">`barang`.`sd`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<input type="hidden" name="token" value="2a3b7029377577494367754b6a3d2941">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="mahasiswa" targettable="mahasiswa">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `mahasiswa` ADD UNIQUE(`NIM`);</span>
                        </div>
